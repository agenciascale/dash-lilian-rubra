...
(function () {
  ...
  function renderFollowers(m, fol) {
    ...
    var stages = [
      ...
      { n: 'Visitas ao perfil', big: M.int(m.visits), bg: '#7ecb1c', ink: '#0c1400', cl: 'Custo / visita', cv: M.money(m.cpVisit), sub: 'visitas ao perfil (Resultado do Gerenciador · perfil + Página)' },
  ...
  function renderOverview() {
    ...
    var heroHTML =
      ...
      hc('👤 Visitas ao perfil', 'Gerenciador', M.int(cur.visits), 'custo/visita ' + M.money(cur.cpVisit), '', true) + OP('→') +
  ...
  function renderFunnel(c, fol) {
    var stages = [
      ...
      { n: 'Visitas ao perfil', big: M.int(c.visits), bg: '#356606', ink: '#fff', cl: 'Custo / visita', cv: M.money(c.cpVisit), sub: 'visitas ao perfil (Resultado do Gerenciador · perfil + Página)' }
    ];
    if (HAS_FOL) {
  ...
  function renderTraffic() {
    ...
    $('trafficView').innerHTML =
      '<div class="scopenote"><span>🎯 Aba operacional: mídia (Meta) e resultado por anúncio. <b>Visitas ao perfil</b> = <b>Resultado do Gerenciador</b> (perfil + Página · campo `results`); os <b>novos seguidores</b> (coluna N da planilha) ficam na Visão Geral. CTR sempre de <b>link</b>.</span></div>' +
  ...
  function renderReport() {
    ...
    var resumoNote = 'Campanha de <b>seguidores / visitas ao perfil</b>' + (cgR !== 'all' ? ' — <b>' + esc(GROUP_LABEL[cgR]) + '</b>' : '') + '. <b>Visitas ao perfil</b> = <b>Resultado do Gerenciador</b> (perfil + Página) · <b>Novos seguidores</b> = número real da planilha (coluna N), que você atribui à campanha. Custo por seguidor bom ≤ R$2,00.';
  ...
  function shell() {
    ...
    $('footer').innerHTML =
      ...
      '<b>Visitas ao perfil</b> = Resultado do Gerenciador (perfil + Página) (' + int(totVis) + ' no total) · <b>Novos seguidores</b> = coluna N · Seguid. (' + int(totFol) + ' no total). ' +
